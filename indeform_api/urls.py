...
from .views.chatroom import ChatRoomCreateInvitationView, ChatRoomListCreateView, ChatRoomRetrieveView, \
    ChatRoomParticipantsView

from .views.auth import CustomTokenObtainPairView, RegisterView
from .views.invitation import InvitationsView,  InvitationsAcceptDenyView
...
urlpatterns = [
    ...
    path('chatrooms/<int:pk>', ChatRoomRetrieveView.as_view(), name='chatroom_retrieve'),
